...
Due to ever increasing image size, some applications no longer come pre-installed.  See the section on installing applications via Snap for more details.
...
1. Release XXX 
    * Removed: Windows support (I no longer have access to a Window 10 box, prevenging me from diagnosing Windows issues)
    * Removed: VPN support (it no longer installs and I don't have access to a VPN account to diagnose issues)
    * Removed: Python 3 PPA (it no longer installs and the offical repository contains a recent version)
    * Removed: Atom (see section on Snap for installation instructions)
    * Removed: Visual Studio Code (see section on Snap for installation instructions)
    * Removed: Chromium (see section on Snap for installation instructions)
